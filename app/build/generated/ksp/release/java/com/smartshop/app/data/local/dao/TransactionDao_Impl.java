...
public final class TransactionDao_Impl implements TransactionDao {
  ...
  public TransactionDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTransaction = new EntityInsertionAdapter<Transaction>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `transactions` (`id`,`itemsJson`,`total`,`timestamp`) VALUES (nullif(?, 0),?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindLong(3, entity.getTotal());
      ...
      public List<Transaction> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Transaction(_tmpId,_tmpItemsJson,_tmpTotal,_tmpTimestamp);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public Transaction call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpTimestamp;
            _tmpTimestamp = _cursor.getLong(_cursorIndexOfTimestamp);
            _result = new Transaction(_tmpId,_tmpItemsJson,_tmpTotal,_tmpTimestamp);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Flow<List<Transaction>> getTransactionsInRange(final long startTime, final long endTime) {
  ...
  @Override
  public Object getTotalSales(final Continuation<? super Integer> $completion) {
    final String _sql = "SELECT SUM(total) FROM transactions";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
  ...
  @Override
  public Object getTodaySales(final long startOfDay, final long endOfDay,
      final Continuation<? super Integer> $completion) {
    final String _sql = "SELECT SUM(total) FROM transactions WHERE timestamp >= ? AND timestamp <= ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 2);
    int _argIndex = 1;
